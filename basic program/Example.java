...
assignment statements to assign a value to each variable. Run the program; examine the output. 
Now let's break something: Remove one of the declarations from the program. Can you compile 
it? 
