...
o Notice carefully: there is a single space between the two ' marks.
• Change the 'A' into '' and try to compile. 
o Notice carefully: there is no character between the two ' marks.
• Change the 'A' into "A" and try to compile the program. 
o (The double quotes " signify a String, which is something different from a char).
